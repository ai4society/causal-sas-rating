...
def run_bf(i):
    ...
    bf.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,0)
    bf.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,1)
...
def run_random(i):
    ...
    random_sas.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,0)
    random_sas.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,1)
...
def run_dbert(i):
    ...
    dbert_sas.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,0)
    dbert_sas.g1("../data/data-generated/group1/e{}.csv".format(i),i,1,1)
