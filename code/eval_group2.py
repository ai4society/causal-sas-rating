...
def run_bf(i):
    ...
    bf.g2("../data/data-generated/group2/e{}.csv".format(i),i,1)
...
def run_random(i):
    ...
    random_sas.g2("../data/data-generated/group2/e{}.csv".format(i),i,1)
...
def run_dbert(i):
    ...
    dbert_sas.g2("../data/data-generated/group2/e{}.csv".format(i),i,1)
