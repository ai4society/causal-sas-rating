...
##Calculating the difference between scores of original english dataset and German to OTO dataset without names.
def diff_nonames_de():
...
##Calculating the difference between scores of original english dataset and German to OTO dataset with names.
def diff_withnames_de():
