...
def run_bf(i):
    ...
    bf.g3("../data/data-generated/group3/e{}.csv".format(i),i,2)
...
def run_gru(i):
    ...
    ClassificationGRU.g3("../data/data-generated/group3/e{}.csv".format(i),i,2)

def run_random(i):
    sys.path.insert(1, 'sentiment-models/random_sas/')
    import random_sas
    print("Generating results from random SAS...")
    random_sas.g3("../data/data-generated/group3/e{}.csv".format(i),i,2)
...
def run_textblob(i):
    ...
    textblob_sas.g3("../data/data-generated/group3/e{}.csv".format(i),i,2)

def run_dbert(i):
    sys.path.insert(1, 'sentiment-models/DistilBERT/')
    import dbert_sas
    print("Generating results from DistilBERT SAS...")
    dbert_sas.g3("../data/data-generated/group3/e{}.csv".format(i),i,2)
